...
export const useMessageActions = (): MessageActions => {
    ...
    return {
        displayInfoMessage: (message: string, duration: number, bootstrapClasses?: string): string => displayToast(
            ToastType.Info,
            message,
            duration,
            undefined,
        ...
        displayErrorMessage: (message: string, bootstrapClasses?: string): string => displayToast(
            ToastType.Error,
            message,
            0,
            undefined,
